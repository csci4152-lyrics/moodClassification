...
my $is_sentence = 0;
my $constant1 = 0 ;
my $constant2 = 0.04347826089;
my $constant3 = 0.09999999999999998999999999999999999999999999999999999999999999999999999999999999999999;
my $index;
my $temp1;
my $sum = 0;
